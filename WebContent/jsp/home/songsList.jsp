...
<div class="wrapper">
  <div id="body_section">
    ...
    <img alt="img" src="<%=MegacriticCommonConstants.KICKER_IMG_PATH %><s:property value="%{#song.extraLargeKickerImage}"/>" />
    </a>
    <div class="l_play_icon_h"></div>
    </div>
    <div class="top_photo_des"><a href="#"><s:property  value="%{#song.videoTitle}"/></a></div>
    </div>
    <ul class="bg">
    </s:if>
    <s:else>
