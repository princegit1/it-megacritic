...
//response.sendRedirect(Constants.PAGE_NOT_FOUND);
    ...
    <div class="video_main_cont">  <div class="com_head" style="margin-top:10px">
          <h2><strong>LATEST SONGS</strong><span></span><small></small></h2>
        </div>
    <ul class="bg">
    
     <s:iterator id="video" value="%{songs}" status="stat">
   ...
   <s:property  value="%{#video.videoTitle}"/>
    ...
    <div class="com_head">
          <h2><strong>OTHERS SONGS</strong><span></span><small></small></h2>
        </div>
